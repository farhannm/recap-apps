...
class RemoteDataSource(private val api: ApiService) {
    ...
    suspend fun changePass(data: UserRequest) = api.changePass(data.id, data)
    ...
    suspend fun createDetailPekerjaan(data: DetailPekerjaan) = api.createDetailPekerjaan(data)
